...
public class WidgetProvider extends AppWidgetProvider {
    ...
    void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
                                int appWidgetId) {
        RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.widget_light_green);
    ...
    private RemoteViews initViews(Context context, AppWidgetManager widgetManager, int widgetId) {
        ...
        RemoteViews mView = new RemoteViews(context.getPackageName(), R.layout.widget_light_green);
